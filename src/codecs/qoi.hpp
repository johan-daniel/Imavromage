...
#define QOI_OP_RGB     0xFE;     // 8 bits tag
#define QOI_OP_RGBA    0xFF;     // 8 bits tag
#define QOI_OP_LUMA    0x80;     // 2 bits tag
#define QOI_OP_INDEX   0x00;     // 2 bits tag
#define QOI_OP_DIFF    0x40;     // 2 bits tag
